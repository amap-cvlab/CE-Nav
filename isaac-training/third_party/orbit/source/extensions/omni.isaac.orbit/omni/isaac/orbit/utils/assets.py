...
NVIDIA_NUCLEUS_DIR = '/home/amapcv/wzb/files/assets_asaac_lab_1.2/assets_all/NVIDIA'
ISAAC_NUCLEUS_DIR = '/home/amapcv/wzb/files/assets_asaac_lab_1.2/assets_all/Isaac'
ISAAC_ORBIT_NUCLEUS_DIR = os.path.join(ISAAC_NUCLEUS_DIR, 'Samples', 'Orbit')
